...
public class AnomalyDetector {
	...
	public static void callMe(int i, int r, int c, double gini, String run, int gridRes) throws Exception {
		...
		String filePath = File.separator + "home" + File.separator + "ferdinand" + File.separator + "Documents" + File.separator + "NYU" + File.separator + "Data" + File.separator + "telang";
		...
		String inputFile = filePath + File.separator + "ctgrid_p_1110_h_"+gridRes+".csv";
		...
		System.out.println("InputFileParser constructor done");
		...
		System.out.println("Number of clusters: " + clusters.size() + " " + clusters.size());		
	...
	public static void main(String[] args) throws Exception {
		...
		String gridCoordFile = "/home/ferdinand/Documents/NYU/Data/harish_grid_h/gridCoordinates_"+ gridRes+ ".txt";
