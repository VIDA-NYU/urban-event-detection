...
#gridCoordPath = /home/ferdinand/Documents/NYU/Data/harish_grid_h/


#%% ------------- Write HARISH_GRID_HOUR coordinates file -----------------
coord_input = open(dirPath + "gridCoordinates_" +str(gridRes) + ".txt")
coord_output = open(dirPath + "coord_grid_"+ str(gridRes) + ".csv", "w")
...
# ------ hourly aggregation -------
ct_p_grid1110_h = open(dirPath + "ct_p_grid1110_h_"+str(gridRes)+".csv", "w")
...
# ------ hourly aggregation -------
ct_d_grid1110_h = open(dirPath + "ct_d_grid1110_h_"+str(gridRes)+".csv", "w")
